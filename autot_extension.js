...
(function(ext) {
  ...
  function processSysexMessage() {
    switch(storedInputData[0]) {
      ...
      for (var i = 1; i < sysexBytesRead; i++)
      	...
      	dist_read = storedInputData[i];
      	console.log(dist_read);
      break;
    }
  }
  ...
  ext.silnik1 = function(motor, direction, speed) {
  ...
  var blocks = {
    en: [
      ...
      [' ', 'silnik 1 %m.hwOut to pin %n', 'connectHW', 'led A', 3],
  ...
  ScratchExtensions.register('ScratchX Robot', descriptor, ext, {type:'serial'});
